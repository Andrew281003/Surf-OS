...
internal static class Program
{
    ...
    private static void TestPackageBuilder(string testRoot)
    {
        ...
        Check(File.Exists(Path.Combine(projectPath, "package.json")) &&
            ...
            "theme workspace contains metadata and an editable payload");
    ...
    private static void TestFilesystemInspection(string testRoot)
    {
        ...
        process!.WaitForExit();
        Check(process.ExitCode == 0, "junction test fixture created");
    ...
    private static void TestExtendedShell(string testRoot)
    {
        ...
        if (OperatingSystem.IsWindows())
        {
            ...
            Check(!running && SurfOsApplication.RebootRequested, "reboot requests boot-loop restart without restarting Windows");
