...
- `SurfOS.Infrastructure` integrates with host services, Windows VHDX or macOS directory-backed storage, persistence, networking, cloud services, audio, and security.
