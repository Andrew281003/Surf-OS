...
namespace SurfOS2
{
    internal class Screen_Print
    {
        public static void Call_Setup()
        {
            ...
            RetroConsole.TypeLine(
                OperatingSystem.IsWindows()
                    ? "The default SurfOS drive is a safe 15 GB fixed VHDX and can be customized."
                    : "SurfOS uses a directory-backed system volume with a customizable logical capacity.",
                3);
        ...
        {
            RetroConsole.ApplyColors(
                Import.Variables.activeForegroundColor,
                Import.Variables.activeBackgroundColor);
        }
        ...
        public static void LoadAndApplyTheme(string themeName, bool sudoOverride = false)
        {
            ...
            Console.WriteLine("\nTIP: Use 'theme load <name> --force' to force load at your own risk.");
                    ...
                    if (Enum.TryParse(theme.TargetColor, true, out ConsoleColor customForeground))
                        Import.Variables.activeForegroundColor = OperatingSystem.IsMacOS()
                            ? PromoteDarkForeground(customForeground)
                            : customForeground;
        ...
        private static ConsoleColor PromoteDarkForeground(ConsoleColor color) => color switch
        {
