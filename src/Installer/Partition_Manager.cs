...
internal static class Partition_Manager
{
    ...
    public static bool HasMountConfiguration => File.Exists(MountConfigurationPath);
    ...
    {
        string driveRoot = Path.GetPathRoot(installPath) ?? $"{Import.Variables.partitionDriveLetter}:\\";
    ...
    public static long GetUsedBytes(string installPath)
    {
        ...
        try
        {
            ...
            return Directory.EnumerateFiles(installPath, "*", options)
