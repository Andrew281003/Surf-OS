...
* Windows
* .NET 9 SDK
* Windows Console Host recommended
...
You can also use `Launch-SurfOS.cmd` for the intended console experience.

On first launch, SurfOS offers **Guided** or **Advanced** setup. It creates a VHDX virtual system disk, formats it as NTFS, and mounts it as a normal Windows drive—preferably `S:`.
