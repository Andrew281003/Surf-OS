...
namespace SurfOS2
{
    ...
    {
        public static bool Main_Directory()
        {
            try
            {
                ...
                // Populate the platform-specific SurfOS system volume.
                Directory.CreateDirectory(mainFolder);
                PartitionManifest partition = Partition_Manager.Create(mainFolder);
                KernelLog.Initialize(mainFolder);
                KernelLog.Info(
                    "install",
                    $"{partition.VolumeType} {partition.Label} available at {partition.MountPoint} with {partition.CapacityGb:0} GB capacity");
                ...
                Import.DatabaseRecord administrator = new()
                {
                    ID = Import.Variables.uuid,
                    Username = Import.Variables.userName,
                    Admin = $"{Import.Variables.uuid}::{Import.Variables.machineName}"
                };
                AccountSecurity.SetPassword(administrator, Import.Variables.userPassword);
                Import.Variables.userPassword = string.Empty;
                List<Import.DatabaseRecord> dbList = [administrator];
                ...
                var unholyPack = new Import.SurfTheme {
                    ...
                    AsciiArt = """
                      ...
                      / / / /___  / / / /___  / /_  __/ ___/__  _______/ __ \/ ___/
                     / / / / __ \/ /_/ / __ \/ / / / /\__ \/ / / / __  / / / /\__ \
                    / /_/ / / / / __  / /_/ / / /_/ /___/ / /_/ / /_/ / /_/ /___/ /
                    \____/_/ /_/_/ /_/\____/_/\__, /____/\__,_/\__,_/\____/____/
                                              /____/
                    """
                };
            ...
            catch (Exception error)
            {
                ...
                Console.WriteLine($"SurfOS installation failed:\n\n{error.Message}\n");
                Console.ResetColor();
                if (error is UnauthorizedAccessException)
                {
                    Console.WriteLine("Please start the program as an administrator and try again.");
                }
                Console.WriteLine("The incomplete installation was not started.");
